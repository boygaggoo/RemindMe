...
#define COCOAPODS_POD_AVAILABLE_DCHideableSectionViewController
#define COCOAPODS_VERSION_MAJOR_DCHideableSectionViewController 0
#define COCOAPODS_VERSION_MINOR_DCHideableSectionViewController 1
#define COCOAPODS_VERSION_PATCH_DCHideableSectionViewController 0
